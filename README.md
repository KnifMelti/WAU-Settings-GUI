...
### Manual installation
- Download, unblock and extract the latest release: [WAU-Settings-GUI-v#.#.#.#.zip](https://github.com/KnifMelti/WAU-Settings-GUI/releases/latest)
...
#### SandboxTest
<img src="Sources/assets/SandboxTest.png" alt="SandboxTest" width="49%"> <img src="Sources/assets/List.png" alt="List" width="49%" align="top">
#### WSB
